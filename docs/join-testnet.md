...
of Bitcoiva to use and details about the genesis file.
:::
...
See the [testnet repo](https://github.com/cosmos/testnets) for details on which version is needed for which testnet, and the [Bitcoiva release page](https://github.com/cosmos/bitcoiva/releases) for details on each release.
