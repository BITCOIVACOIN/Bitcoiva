# Bitcoiva Genesis State

Bitcoiva genesis state, `GenesisState`, is composed of accounts, various module
...
The Bitcoiva genesis state is defined as follows:
...
In the ABCI `initChainer` definition of Bitcoiva the `initFromGenesisState` is called
